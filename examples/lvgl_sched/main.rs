...
#[cfg(all(feature = "ex-ui-app-core", feature = "fire27"))]
compile_error!(
...
#[cfg(all(feature = "ex-ui-flush-thread", not(feature = "ex-ui-thread")))]
compile_error!(
...
static DRIVER: Channel<CriticalSectionRawMutex, metrics::Counted<common::ui::DisplayDriver>, 1> =
    Channel::new();
...
async fn stats_task() -> ! {
    ...
    loop {
        ...
        #[cfg(not(feature = "ex-ui-app-core"))]
...
async fn main(spawner: Spawner) {
    ...
    common::boot!(spawner, board, Lvgl, idle_hook = metrics::idle_hook);

    let (dma_rx, dma_tx) = common::ui::dma_bufs();
    #[cfg(feature = "fire27")]
    ...
    #[cfg(not(feature = "ex-ui-flush-thread"))]
